...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    """
    # Your code here
    y_hat = theta @ feature_vector + theta_0
    return max(0, 1 - (label * y_hat))
#pragma: coderesponse end
...
def average_perceptron(feature_matrix, labels, T):
    ...
    num_features = feature_matrix[0].shape[0]
...
def classify(feature_matrix, theta, theta_0):
    ...
    """
    # Your code here
    y_hat = feature_matrix @ theta + theta_0
...
def classifier_accuracy(
    ...
    return (train_accuracy, val_accuracy, theta, theta_0)
#pragma: coderesponse end
...
#pragma: coderesponse template
def bag_of_words(texts, ignore_words):
    """
